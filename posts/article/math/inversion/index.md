...
日本でも割と流行っているやつ。[noshi大先生のブログ](https://noshi91.hatenablog.com/entry/2020/01/15/185642)
...
$$\sum_i a_i [m\vert i] = \sum_i a_i \sum_j W^{ij} = \sum_j \left(\sum_i a_i (W^{j})^i\right)$$
